...
// أُضيف 600 بين 400 و800 لتضييق الفجوة — بدون هذا الحجم الوسطي كان المتصفح
// يضطر يقفز من 400w مباشرة إلى 800w حتى لو المطلوب فعليًا كان قريبًا من
// 600-700px، مما يحمّل بايتات أكثر من اللازم (مثال مُلاحَظ: عرض مطلوب 662px
// اضطر يستخدم نسخة 800w بدل نسخة أقرب لحجمه).
// أُضيف كمان 500 بين 400 و600: صور بطاقات المنتج المصغّرة (compact، sizes
// "45vw" على الجوال) تحتاج فعليًا عرض ~487px على أجهزة الجوال الشائعة
// (45vw × عرض شاشة نموذجي × كثافة بكسل)، فكانت تضطر تستخدم نسخة 600w
// (فرق ~52% بايتات زيادة) بدل نسخة أقرب لحجمها الفعلي.
const WIDTHS = [400, 500, 600, 800, 1200];
